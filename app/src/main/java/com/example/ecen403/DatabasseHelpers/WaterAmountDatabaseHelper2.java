...
public class WaterAmountDatabaseHelper2 extends SQLiteOpenHelper{
    private static final String DATABASE_NAME = "water_Points2.db";
    ...
    public WaterAmountDatabaseHelper2(Context context) {
