...
public class WaterAmountDatabaseHelper3 extends SQLiteOpenHelper{
    private static final String DATABASE_NAME = "water_Points3.db";
    ...
    public WaterAmountDatabaseHelper3(Context context) {
