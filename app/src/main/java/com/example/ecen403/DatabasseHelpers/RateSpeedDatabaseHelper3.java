...
public class RateSpeedDatabaseHelper3 extends SQLiteOpenHelper {
    private static final String DATABASE_NAME = "rate_Points3.db";
    ...
    public RateSpeedDatabaseHelper3(Context context) {
