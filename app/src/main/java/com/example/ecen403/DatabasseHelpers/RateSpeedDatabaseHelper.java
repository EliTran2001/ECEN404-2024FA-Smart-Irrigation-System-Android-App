...
public class RateSpeedDatabaseHelper extends SQLiteOpenHelper {

    private static final String DATABASE_NAME = "ratePoints.db";
    ...
    public RateSpeedDatabaseHelper(Context context) {
