...
public class Zone7 extends AppCompatActivity {

    FirebaseFirestore db = FirebaseFirestore.getInstance();
    String rtvTemp1, rtvMoisture1, rtvPrecipitation1, rtvStatus1, rtvHumidity1, zone7;
        ...
        db.collection("zones")
                ...
                .addOnFailureListener(new OnFailureListener() {
                    ...
                    public void onFailure(@NonNull Exception e) {
                        Toast.makeText(Zone7.this, "Error = " + e.getMessage(), Toast.LENGTH_SHORT).show();
                    }
                });
        ...
        db.collection("zones")
                ...
                .addOnSuccessListener(new OnSuccessListener<Void>() {
                    ...
                    public void onSuccess(Void aVoid) {
                        Toast.makeText(Zone7.this, "Status updated!", Toast.LENGTH_SHORT).show();
                    }
                })
                .addOnFailureListener(new OnFailureListener() {
                    @Override
                    public void onFailure(@NonNull Exception e) {
                        Toast.makeText(Zone7.this, "Error updating status: " + e.getMessage(), Toast.LENGTH_SHORT).show();
                    }
                });
    }
}