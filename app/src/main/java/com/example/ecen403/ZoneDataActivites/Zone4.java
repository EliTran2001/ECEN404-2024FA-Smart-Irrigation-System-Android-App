...
public class Zone4 extends AppCompatActivity {
    ...
    String rtvTemp1, rtvMoisture1, rtvPrecipitation1, rtvStatus1, rtvHumidity1, zone4, water_amount, time_active, rate_speed;
        ...
        db.collection("zones")
                ...
                .addOnFailureListener(new OnFailureListener() {
                    ...
                    public void onFailure(@NonNull Exception e) {
                        Toast.makeText(Zone4.this, "Error = " + e.getMessage(), Toast.LENGTH_SHORT).show();
                    }
                });
        ...
        db.collection("zones")
                ...
                .addOnSuccessListener(new OnSuccessListener<Void>() {
                    ...
                    public void onSuccess(Void aVoid) {
                        Toast.makeText(Zone4.this, "Status updated!", Toast.LENGTH_SHORT).show();
                    }
                })
                .addOnFailureListener(new OnFailureListener() {
                    @Override
                    public void onFailure(@NonNull Exception e) {
                        Toast.makeText(Zone4.this, "Error updating status: " + e.getMessage(), Toast.LENGTH_SHORT).show();
                    }
                });
    }
}