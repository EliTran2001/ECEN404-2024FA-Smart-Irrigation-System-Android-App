...
public class Zone9 extends AppCompatActivity {
    FirebaseFirestore db = FirebaseFirestore.getInstance();
    String rtvTemp1, rtvMoisture1, rtvPrecipitation1, rtvStatus1, rtvHumidity1, zone9;
        ...
        db.collection("zones")
                ...
                .addOnFailureListener(new OnFailureListener() {
                    ...
                    public void onFailure(@NonNull Exception e) {
                        Toast.makeText(Zone9.this, "Error = " + e.getMessage(), Toast.LENGTH_SHORT).show();
                    }
                });
        ...
        db.collection("zones")
                ...
                .addOnSuccessListener(new OnSuccessListener<Void>() {
                    ...
                    public void onSuccess(Void aVoid) {
                        Toast.makeText(Zone9.this, "Status updated!", Toast.LENGTH_SHORT).show();
                    }
                })
                .addOnFailureListener(new OnFailureListener() {
                    @Override
                    public void onFailure(@NonNull Exception e) {
                        Toast.makeText(Zone9.this, "Error updating status: " + e.getMessage(), Toast.LENGTH_SHORT).show();
                    }
                });
    }
}